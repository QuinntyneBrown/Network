...
{
    public class UpdateTeamTechnology
    {
        ...
        public class Handler : IRequestHandler<Request, Response>
        {
            ...
            {
                var teamTechnology = await _context.TeamTechnologies.SingleAsync(x => x.TeamTechnologyId == request.TeamTechnology.TeamTechnologyId);
